...
export class HomePage extends BasePage {
  ...
  private forms: Locator;
  private awf: Locator;
  private widgets: Locator;
  private interactions: Locator;

  constructor(page: Page, browser: Browser, context: BrowserContext) {
    super(page, browser, context);
    this.elements = page.locator(
      '//h5[text()="Elements"]/../..//*[contains(@class,"avatar")]'
    );
    this.forms = page.locator(
      '//h5[text()="Forms"]/../..//*[contains(@class,"avatar")]'
    );
    this.awf = page.locator(
      '//h5[text()="Alerts, Frame & Windows"]/../..//*[contains(@class,"avatar")]'
    );
    this.widgets = page.locator(
      '//h5[text()="Widgets"]/../..//*[contains(@class,"avatar")]'
    );
    this.interactions = page.locator(
      '//h5[text()="Interactions"]/../..//*[contains(@class,"avatar")]'
    );
  }
